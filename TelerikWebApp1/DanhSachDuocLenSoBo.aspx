<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DanhSachDuocLenSoBo.aspx.cs" Inherits="TelerikWebApp1.DanhSachDuocLenSoBo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
       <h1>DANH SÁCH HỘ ĐƯỢC LÊN SỔ BỘ THUẾ TRONG THÁNG <%= DateTime.Now.Month.ToString() %> - <%= DateTime.Now.Year.ToString() %></h1>
    <br />
