<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanhSachHetHanNgungNghi.aspx.cs" MasterPageFile="~/Site1.Master" Inherits="TelerikWebApp1.DanhSachHetHanNgungNghi" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="content" runat="server">
    <h1>Danh Sách Hộ Kinh Doanh Hết Hạn Ngưng Nghỉ
    </h1>
    <br />
